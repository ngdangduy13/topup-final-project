import { Text, View, Image, TouchableOpacity, InteractionManager } from 'react-native';
        ...
        return (
            <BasicLayout>
                {this.props.isBusy
                    ...
                    >
                        <Rect x="21.56" y="17.61" rx="2" ry="2" width={getLayout().deviceWidth} height="150" />
                        <Rect x="21.56" y="184.61" rx="8" ry="8" width="277" height="17" />
                        <Rect x="21.56" y="215.61" rx="8" ry="8" width="201" height="13" />
                    </ContentLoader>
                    : <View style={{ flex: 1, width: '100%' }}>
                        <View>
                            <FastImage source={{ uri: quizIsPlaying.coverImageUrl }} style={styles.Image} resizeMode="cover" />
                        ...
                        <View style={styles.ContentContainer}>
                            <TextMontserrat style={{ fontFamily: 'Montserrat-SemiBold', fontSize: 17, padding: 10 }}>
                                {quizIsPlaying.title}
                            </TextMontserrat>
                        </View>
                        <View style={styles.ContentContainer}>
                            <TextMontserrat style={{ fontFamily: 'Montserrat-SemiBold', padding: 10 }}>Description</TextMontserrat>
                ...
                <View style={styles.Footer}>
                    ...
                    <TouchableOpacity style={styles.PlayButton} onPress={this.onPlay}>
                        <IconFontAwesome name="play" size={22} color="#fff" style={{ marginRight: 6 }} />
                        <Text style={{ fontFamily: 'Montserrat-ExtraBold', color: '#fff', fontSize: 17 }}>Play</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.CircleBack} onPress={this.onGoScoreboard}>
