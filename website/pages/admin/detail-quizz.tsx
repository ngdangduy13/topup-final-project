...
import { Row, Divider, Col, List, Typography, Icon, Card, Tag } from 'antd';
...
class DetailQuizzPage extends React.Component<UserPageProps> {
  ...
  render(): JSX.Element {
    ...
    let color;
    if (currentQuiz.state === 'PUBLISHED') {
      color = 'green';
    } else if (currentQuiz.state === 'DRAFT') {
      color = 'orange';
    } else if (currentQuiz.state === 'REMOVED') {
      color = 'red';
    }
    return (
      <AdminLayout
            ...
            <div className="sider">
              <Row>
                ...
                <div style={{ marginLeft: 10 }}>
                  <Typography.Title editable={{ onChange: this.onChange }} level={4}>
                    {currentQuiz.title}
                  </Typography.Title>
                </div>
                <Divider />
                <div style={{ marginLeft: 10 }}>
                  <div style={{paddingBottom: 12}}>
                    State:
                      <Tag color={color} style={{marginLeft: 12}}>{currentQuiz.state}</Tag>
                  </div>
                  <Typography.Paragraph editable={{ onChange: this.onChange }}>
