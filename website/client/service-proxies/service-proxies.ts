...
export class ServiceProxy {
    ...
    constructor(baseUrl?: string, http?: { fetch(url: RequestInfo, init?: RequestInit): Promise<Response> }) {
        ...
        this.baseUrl = baseUrl ? baseUrl : config.nextjs.apiUrl;
    }
     ...
     * @return successful operation
     */
    getAllQuizzes(token: string, searchTerm: string | undefined, state: string | undefined, pageIndex: string | undefined, pageSize: number | undefined, sortBy: string | undefined, pageOrientation: boolean | undefined): Promise<string> {
