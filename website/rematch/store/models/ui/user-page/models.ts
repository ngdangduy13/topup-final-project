...
const usersPageModels: ModelConfig<UserPageState> = createModel({
  ...
  reducers: {
    ...
    fetchDataSuccess: (state: UserPageState, payload: IFetchDataSuccessPayload): UserPageState => {
      return {
        ...state,
        isBusy: false,
        listUser: payload,
    ...
    onError: (state: UserPageState, payload: IErrorPayload): UserPageState => {
      return {
        ...state,
        isBusy: false,
    ...
    setSearchTerm: (state: UserPageState, payload: string): UserPageState => {
      return {
        ...state,
        searchTerm: payload,
      };
    },
    setSelectedRoleFilter: (state: UserPageState, payload: string): UserPageState => {
      return {
        ...state,
        selectedRoleFilter: payload,
      };
    },
    switchUserProfileVisibility: (state: UserPageState, payload: boolean): UserPageState => {
      return {
        ...state,
        isUserProfileOpen: !payload,
      };
    },
    fetchUserDetail: (state: UserPageState, payload: IFindUserDetail): UserPageState => {
      return {
        ...state,
        currentUser: payload,
      };
    },
    updateUserSuccess: (state: UserPageState, _payload: any): UserPageState => {
      return {
        ...state,
        errorMessage: '',
        isBusy: false,
    ...
    setSelectedRole: (state: UserPageState, payload: string[]): UserPageState => {
      return {
        ...state,
        currentUser: {
          ...state.currentUser,
    ...
    onChangeScorePointReducer: (state: UserPageState, payload: any): UserPageState => {
      return {
        ...state,
        ...payload,
      };
    },
    onChangeReasonReducer: (state: UserPageState, payload: any): UserPageState => {
      return {
        ...state,
        ...payload,
      };
    },
    setPageIndex: (state: UserPageState, payload: any): UserPageState => {
      return {
        ...state,
        ...payload,
      };
    },
    setPageOrientation: (state: UserPageState, payload: any): UserPageState => {
      return {
        ...state,
        ...payload,
      };
    },
    setOrientationButtonVisibility: (state: UserPageState, payload: any): UserPageState => {
      return {
        ...state,
        ...payload,
      };
    },
    setFirstPageCheck: (state: UserPageState, payload: any): UserPageState => {
      return {
        ...state,
        ...payload,
      };
  ...
  effects: {
    async fetchUserListEffect(_payload: any, _rootState: any): Promise<void> {
      try {
        this.onLoading();
        ...
        const result = await service.findUsers(
          ...
          _rootState.usersPageModels.pageSize,
          'createdAt',
        ...
        if (result && (result as any).data && (result as any).data.length > 10) {
          (result as any).data.splice(
            _rootState.usersPageModels.userListPageOrientation ? 10 : 0,
            1
          );
        }
    ...
    async searchChangeEffect(_payload: any, _rootState: any): Promise<void> {
      try {
        this.onLoading();
    ...
    async updateUserRoleEffect(payload: IUpdateUserRolePayload, _rootState: any): Promise<void> {
      try {
        this.onLoading();
        const service = new ServiceProxy();
    ...
    async redeemPointEffect(
      ...
      try {
        this.onLoading();
        const service = new ServiceProxy();
        const updateUserDetailResult = await service.redeemPoints(payload.userId, {
        ...
        const userDetail = await service.findUserById(
          '',
          _rootState.usersPageModels.currentUser._id.toString()
        );
    ...
    async getRedemptionHistoryEffect(_payload: any, _rootState: any): Promise<void> {
      try {
        this.onLoading();
        const service = new ServiceProxy();
        const result = await service.getRedeemPoints(
          _rootState.usersPageModels.currentUser._id === undefined
            ? ''
        ...
        if (_rootState.usersPageModels.redemptionHistoryPageOrientation) {
          this.setOrientationButtonVisibility({
            isRedemptionHistoryNextDisabled:
              result && (result as any).data && (result as any).data.length < 11,
          });
          ...
          this.setOrientationButtonVisibility({
            isRedemptionHistoryPrevDisabled:
              result && (result as any).data && (result as any).data.length < 11,
          });
          this.setOrientationButtonVisibility({
            isRedemptionHistoryNextDisabled: false,
        ...
        if (result && (result as any).data && (result as any).data.length > 10) {
          (result as any).data.splice(
            _rootState.usersPageModels.redemptionHistoryPageOrientation ? 10 : 0,
            1
          );
        }
    ...
    async deleteRedemptionHistoryEffect(
      ...
      try {
        this.onLoading();
        const service = new ServiceProxy();
        const updateUserDetailResult = await service.cancelredeemPoints(payload.userId, {
    ...
    async createUserEffect(payload: ICreateUsersInput, _rootState: any): Promise<void> {
      try {
        this.onLoading();
        const service = new ServiceProxy();
